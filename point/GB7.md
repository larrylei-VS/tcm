### Crook of the Temple QŪBÌN
![[GB-7 曲鬓.png|250]]
- Meeting point of the Gall Bladder and Bladder channels

#### Location

In the temporal region, within the hairline, level with and one finger-breadth anterior to [Jiǎosūn SJ-20](https://app.amanualofacupuncture.com/point/SJ-20).

#### Location Notes

[Jiǎosūn SJ-20](https://app.amanualofacupuncture.com/point/SJ-20) is located directly level with the apex of the ear, when the ear is folded forwards. Fold the ear so that the posterior part of the upper helix directly covers the anterior part of the upper helix. Take care not to push the whole of the ear forwards.
...
- Vomiting, stiff neck with inability to turn the head.
...
- 头痛、颊及下颌区肿胀、牙关紧闭、失语、口眼歪斜。
- 呕吐、颈僵不能转头。

#### 1.7. 临床应用总结

- 适用于头痛、颊及下颌区肿胀、牙关紧闭、失语、口眼歪斜。
- 适用于呕吐、颈僵不能转头。
